# Dataset Relationship Engine — HIBI

> **Status:** Phases 1–3 implemented | Branch: `feature/dataset-relationships-design`
...
Apache Superset (HIBI fork). Users can declare explicit relationships between
...
*Part of the HIBI project — Apache Superset fork with enhanced dataset relationships.*
